...
import { AllureCommandStep, ParameterOptions, StepBodyFunction } from "allure-js-commons";
declare type AllureWorld = Omit<AllureCommandStep, "attach" | "name" | "attachments" | "metadata">;
export declare class CucumberAllureWorld extends World implements AllureWorld {
